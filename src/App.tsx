...
const WORD_CATEGORIES_HIERARCHICAL:  Record<string, Record<string, string[]>> = {
  "Time, Dates & Numbers": {
    ...
    "Times": ["Weekdays", "Weekend", "Midday", "Midnight", "Fortnight", "Millennium", "Century", "Decade"],
    "Months": ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"],
    "Units & Systems": ["Altitude", "Breadth", "Depth", "Width", "Height", "Length", "Mass", "Frequency", "Volume", "Dimension", "Imperial", "Metric"],
    "Geometry": ["Circular", "Curved", "Cylindrical", "Oval", "Polygon", "Rectangular", "Spherical", "Spiral", "Square", "Triangular"]
  },
  
  "Education & Academic Context": {
    "University Life": ["Bachelor", "Degree", "Diploma", "Certificate", "Dissertation", "Thesis", "Semester", "Module", "Courses", "Assessment", "Assignment", "Deadline", "Extension", "Graduation", "Commencement", "Alumni", "Reunion", "Retention", "Outcomes"],
    "Study Terms": ["Advanced", "Attendance", "Classroom", "Compound", "Department", "Experiment", "Background", "Feedback", "Discussion", "Guidelines", "Education", "Intermediate", "Introductory", "Knowledge", "Media", "Secondary", "Primary", "Proofreading", "Report", "Writing", "Research", "Schedule", "Speech", "Stationery", "Support", "Tasks", "Topic", "Vocabulary"],
    "People & Roles": ["Tutor", "Supervisor", "Advisor", "Lecturer", "Registrar", "Faculty", "Staff", "Pupil", "Student", "Overseas Student", "Foreign", "International Student", "Freshman", "Senior", "Junior"],
    "Facilities":  ["Campus", "Nursery", "Library", "Laboratory", "Main Hall", "Computer Centre", "Dining Room", "Canteen", "Cafeteria", "Accommodation", "Homestay", "Dormitory", "Resources Room"],
    "Study Materials": ["Textbook", "Dictionary", "Handout", "Leaflet", "Questionnaire", "Survey", "Data", "Statistics", "Reference", "Bibliography", "Publication", "Encyclopedia", "Note", "Pencil", "Laptop"],
  ...
  "Money, Business & Marketing": {
    "Banking & Finance": ["Bank Statement", "Current Account", "Deposit", "Withdraw", "Overdraft", "Debt", "Deficit", "Interest Rate", "Loan", "Mortgage", "Investment", "Income", "Budget", "Tax", "Currency", "Cash", "Cheque", "Credit Card", "Debit Card", "Annuity", "Counterfeit Money", "Family Finances", "Grace Period", "In Advance", "Interest-Free", "Low-Risk Investment", "Mastercard", "Monthly Membership", "Poverty", "Public Money", "Retail Voucher", "Taxpayers' Money", "VISA"],
    "Shopping & Costs": ["Affordable", "Expensive", "Cheap", "Reasonable", "Refund", "Partial", "Non-refundable", "Purchase", "Discount", "Special Offer", "Coupon", "Voucher", "Duty-Free", "Tuition Fees", "Annual Fee", "Distribution Costs"],
    "Business & Management": ["Marketing", "Strategy", "Recruitment", "Leadership", "Management", "Profit Margin", "Merchandise", "Manufacture", "Interview", "Trainee", "Internship", "Employment", "Employer", "Employee", "Colleague", "Workforce", "Cooperation", "Collecting Data", "Competition", "Industry", "Products"],
    "Marketing Tools": ["Business Card", "Newsletter", "Catalogue", "Display", "Poll", "Commercial", "Advertisement", "Customer", "TV Program"]
  },
  
  "Food, Dining & Nutrition": {
    "Basic Foods": ["Water", "Juice", "Coffee", "Tea", "Soup", "Salad", "Sandwich", "Chicken", "Beef", "Pork", "Lamb", "Fish", "Sugar", "Salt", "Butter", "Sauce", "Bread", "Rice", "Pasta", "Pizza", "Burger", "Cheese", "Yoghurt", "Egg", "Egg Yolk", "Egg White", "Meat", "Seafood", "Beans", "Nut", "Cereal", "Meal", "Salad Bar"],
    "Fruits & Vegetables": ["Apple", "Banana", "Citrus Fruit", "Orange", "Lemon", "Tomato", "Potato", "Pepper", "Onion", "Garlic", "Carrot", "Vegetable", "Fruit", "Corn"],
    ...
    "Dining Items": ["Beverage", "Menu", "Refreshment", "Starter", "Main Course", "Dessert", "Snack", "Chocolate", "Takeaway"]
  },
  ...
  "Nature, Environment & Weather": {
    "Disasters & Weather": ["Earthquake", "Flood", "Drought", "Hurricane", "Tornado", "Typhoon", "Storm", "Avalanche", "Landslide", "Volcanic Eruption", "Disaster", "Catastrophe", "Humidity", "Moisture", "Breeze", "Wind", "Lightning", "Thunder", "Temperature", "Freezing", "Chilly", "Hot", "Dry", "Wet", "Dusty", "Forecast", "Cold", "Cool", "Sticky", "Warm"],
    "Landscape": ["Mountain", "Hill", "Valley", "Cliff", "Canyon", "Desert", "Oasis", "Forest", "Jungle", "Island", "Coast", "Beach", "Reef", "Lake", "River", "Pond", "Waterfall", "Dam", "Field", "Footbridge"],
    "Environmental Issues": ["Pollution", "Contamination", "Acid Rain", "Global Warming", "Greenhouse Effect", "Deforestation", "Erosion", "Desertification", "Exhaust Fumes", "Carbon Dioxide", "Waste", "Landfill", "Smog", "Burning Fossil Fuels", "Chemical-Free", "Climate", "Degradation", "Environmentally Friendly", "Nitrogen Oxide", "Ocean Currents", "Oxygen", "Sea Level", "Soil Conditioner"],
    "Energy": ["Fossil Fuel", "Coal", "Oil", "Gas", "Firewood", "Solar Power", "Wind Turbine", "Hydroelectric", "Renewable", "Power Plant", "Solar Panels"],
    "Animals": ["Mammal", "Reptile", "Bird", "Insect", "Rodent", "Primate", "Livestock", "Poultry", "Whale", "Penguin", "Lion", "Species", "Extinct", "Cetacean", "Creature", "Seabirds"],
  ...
  "Travel, Transportation & Places": {
    "Land Transport": ["Car", "Automobile", "Taxi", "Cab", "Bus", "School Bus", "Minibus", "Single-Decker", "Coach", "Truck", "Lorry", "Tow Truck", "Forklift", "Van", "Tram", "Train", "Freight Train", "Steam Train", "Subway", "Underground", "Tractor", "Jeep", "Camper", "Pickup", "Tanker", "Transporter"],
    "Water Transport":  ["Ship", "Boat", "Ferry", "Hovercraft", "Hydrofoil", "Liner", "Canoe", "Kayak", "Dinghy", "Rowboat", "Paddle Steamer", "Cabin Cruiser", "Container Ship", "Gondola", "Lifeboat", "Narrowboat", "Punt", "Sailboat", "Shipment"],
    "Air Transport": ["Airplane", "Aircraft", "Helicopter", "Balloon", "Airship", "Seaplane", "Cargo Plane"],
    "Travel Terms": ["Passenger", "Crew", "Pilot", "Driver", "Ticket", "Reservation", "Visa", "Luggage", "Terminal", "Platform", "Harbour", "Airport", "Station", "View", "Souvenir", "Tourist Attraction", "Guided Tour", "Expedition", "Aquarium", "Culture", "Guest", "Memorable", "Picnic", "Single Room", "Ticket Office", "Trip"],
    "Geography & Places": ["Continent", "Country", "City", "Capital", "Village", "Suburb", "Region", "Map", "Avenue", "Bridge", "Car Park", "Central Station", "City Centre", "Department Store", "Embassy", "Lane", "Road System", "Street", "Temple", "Mosque", "Bookshop", "Cafe", "City Council", "Conversation Club", "Dance Studio", "Kindergarten", "Park", "Parliament", "Restaurant", "Sports Centre"],
    ...
    "Languages": ["English", "Bengali", "Chinese", "Mandarin", "French", "German", "Spanish", "Japanese", "Russian", "Arabic", "Hindi", "Portuguese", "Thai", "Greek", "Bilingual", "Filipino", "Italian", "Linguistics", "Persian", "Polyglot", "Trilingual"]
  },
  
  "Housing, Architecture & Materials": {
    "Types of Homes": ["House", "Apartment", "Flat", "Bungalow", "Cottage", "Castle", "Palace", "Skyscraper", "Condominium", "Duplex", "Hut", "Log Cabin", "Fortress", "Dome", "Igloo", "Row House", "Terraced House", "Block of Flats", "Houseboat", "Storey", "Thatched Cottage"],
    "Parts of a Building & Home Items": ["Roof", "Ceiling", "Wall", "Floor", "Window", "Door", "Balcony", "Basement", "Attic", "Garage", "Kitchen", "Bathroom", "Bedroom", "Living Room", "Hallway", "Chimney", "Fence", "Gate", "Ground Floor", "Microwave", "Oven", "Refrigerator", "Sofa"],
  ...
  "Hobbies, Sports & Arts": {
    "Sports": ["Football", "Soccer", "Cricket", "Tennis", "Badminton", "Rugby", "Hockey", "Basketball", "Baseball", "Golf", "Swimming", "Diving", "Surfing", "Skiing", "Snowboarding", "Cycling", "Athletics", "Judo", "Archery", "Squash", "Table Tennis", "Ping-Pong", "Abseiling", "American Football", "Athlete", "Barbell", "Bodyboarding", "Bungee Jumping", "Championship", "Court", "Extreme Sports", "Gymnasium", "Hang-Gliding", "Horse Racing", "Jet-Skiing", "Mountain Biking", "Paragliding", "Pitch", "Polo", "Push-Up", "Recreation", "Show Jumping", "Skydiving", "Snooker", "Stadium", "High Jump", "Javelin", "Treadmill", "Walking", "Rafting", "Windsurfing"],
    "Hobbies": ["Photography", "Painting", "Gardening", "Collecting", "Stamps", "Chess", "Hiking", "Camping", "Pottery", "Woodcarving", "Embroidery", "Orienteering", "Billiards", "Bowls", "Caving", "Climbing", "Darts", "Ice Skating", "Scuba Diving", "Skateboarding"],
  ...
  "Works, Jobs & Professions": {
    "Professions": ["Accountant", "Architect", "Chef", "Engineer", "Doctor", "Dentist", "Teacher", "Professor", "Manager", "Secretary", "Receptionist", "Assistant", "Clerk", "Cashier", "Waiter", "Waitress", "Pilot", "Flight Attendant", "Guard", "Designer", "Decorator", "Psychologist", "Specialist", "Captain", "Craftsman", "Team Leader", "Office Assistant"],
    "Work Concepts": ["Curriculum Vitae", "Qualification", "Experience", "Skill", "Training", "Occupation", "Profession", "Vacancy", "Freelance", "Volunteer", "Workshop", "Teamwork", "Ability", "Appointment", "Confidence", "Information Desk", "Showroom", "Unemployed", "Mail Address", "Work Experience"]
  },
  
  "Descriptive Words, General Concepts & Others": {
    "Devices & Tools": ["Backpack", "Brakes", "Cassette", "Device", "Monitor", "Disk", "Gadget", "Helmet", "Light", "Musical Instrument", "Screen", "Silicon Chip", "Wheels", "Antenna", "Printer"],
    ...
    if (isPlaying && score.total > 0 && ! showResults) {
      ...
      if (originalCategory && originalCategory !== 'Mixed' && WORD_CATEGORIES[originalCategory]) {
        if (selectedCategory?.includes('Mistakes')) {
          ...
          updateCategoryStats(originalCategory, score.correct, totalWords);
        }
              ...
              <div className="max-w-2xl mx-auto">
                ...
                <div className="mt-8 text-center">
                  <button 
                    ...
                    title={score.total > 0 ? "Save progress and exit" : "Exit without saving"}
                  >
                    {score.total > 0 ?   '💾 Save & Exit' : 'Exit Test'}
                  </button>
                </div>
              </div>
            )}
